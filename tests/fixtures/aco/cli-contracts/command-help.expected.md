...
| `archon context approval-capsule <prompt>` | cli | deferred | writes-artifacts | aco-context |
| `archon context approval-capsule-verify` | cli | deferred | read-only | aco-context |
| `archon context compile <prompt>` | cli | deferred | writes-artifacts | aco-context |
...
| `archon context status [prompt]` | cli | deferred | read-only | aco-context |
