...
| 008-prompt-package-spec.md | ACO-COMPILE-001, ACO-ARCHIVE-001, ACO-CLI-001 | compile/archive/CLI acceptance tests | CLI MVP implemented with structured next-command argv and archive output |
| 009-archive-artifact-spec.md | ACO-ARCHIVE-001, ACO-ARCHIVE-002, ACO-ARCHIVE-003 | archive acceptance tests | implemented for CLI MVP with runId and symlink escape checks |
