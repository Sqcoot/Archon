...
- bmad-plugins-marketplace graph is failed; determine whether waiver is acceptable before any architecture decision depends on this repository.
- bmad-sample-data graph is failed; determine whether waiver is acceptable before any architecture decision depends on this repository.
