...
const allowedImports = new Set(['@archon/aco-cli-contracts', '@archon/aco-core', 'zod']);
...
describe('aco-workflows import boundary', () => {
  test('production source is pure and imports only local modules, zod, and ACO contracts', async () => {
