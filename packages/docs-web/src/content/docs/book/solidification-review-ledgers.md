...
- Treat partial graph evidence and waivers as confidence limits.
...
| Status | Use When |
|---|---|
| `Ready` | Required tools are available, required validations pass, and graph/docs waivers are accepted with known impact. |
